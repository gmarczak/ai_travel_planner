...
{
    /// <inheritdoc />
    public partial class AddTransportMode : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AiResponseCaches",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiResponseCaches", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotographerName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    PhotographerUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnonymousCookieId = table.Column<string>(type: "TEXT", nullable: true),
                    TravelPlanId = table.Column<int>(type: "INTEGER", nullable: true),
                    StartedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    Error = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanGenerationStates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    RouteKey = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    EncodedPolyline = table.Column<string>(type: "TEXT", nullable: false),
                    CachedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UsageCount = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoutePolylines", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "TEXT", nullable: true),
                    AnonymousCookieId = table.Column<string>(type: "TEXT", nullable: true),
                    Accommodations = table.Column<string>(type: "TEXT", nullable: false),
                    Activities = table.Column<string>(type: "TEXT", nullable: false),
                    Transportation = table.Column<string>(type: "TEXT", nullable: false),
                    DestinationImageUrl = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiResponseCaches_CreatedAt",
                table: "AiResponseCaches",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AiResponseCaches_ExpiresAt",
                table: "AiResponseCaches",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_AiResponseCaches_PromptHash",
                table: "AiResponseCaches",
                column: "PromptHash",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanGenerationStates_AnonymousCookieId",
                table: "PlanGenerationStates",
                column: "AnonymousCookieId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanGenerationStates_CreatedAt",
                table: "PlanGenerationStates",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_PlanGenerationStates_ExternalId",
                table: "PlanGenerationStates",
                column: "ExternalId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PlanGenerationStates_Status",
                table: "PlanGenerationStates",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_PlanGenerationStates_UserId",
                table: "PlanGenerationStates",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RoutePolylines_CachedAt",
                table: "RoutePolylines",
                column: "CachedAt");

            migrationBuilder.CreateIndex(
                name: "IX_RoutePolylines_RouteKey",
                table: "RoutePolylines",
                column: "RouteKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TravelPlans_CreatedAt",
                table: "TravelPlans",
                column: "CreatedAt");
